...
public class SqlUpdateSourceImpl extends ASTWrapperPsiElement implements SqlUpdateSource {

  public SqlUpdateSourceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitUpdateSource(this);
  }
