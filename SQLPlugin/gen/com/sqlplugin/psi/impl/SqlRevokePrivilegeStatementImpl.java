...
public class SqlRevokePrivilegeStatementImpl extends ASTWrapperPsiElement implements SqlRevokePrivilegeStatement {

  public SqlRevokePrivilegeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitRevokePrivilegeStatement(this);
  }
  ...
  @Override
  @Nullable
  public SqlRevokeOptionExtension getRevokeOptionExtension() {
    return findChildByClass(SqlRevokeOptionExtension.class);
  }
