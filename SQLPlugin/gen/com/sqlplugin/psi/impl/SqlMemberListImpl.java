...
public class SqlMemberListImpl extends ASTWrapperPsiElement implements SqlMemberList {

  public SqlMemberListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SqlMember> getMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SqlMember.class);
  }
