...
public class SqlTargetTableImpl extends ASTWrapperPsiElement implements SqlTargetTable {

  public SqlTargetTableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitTargetTable(this);
  }
