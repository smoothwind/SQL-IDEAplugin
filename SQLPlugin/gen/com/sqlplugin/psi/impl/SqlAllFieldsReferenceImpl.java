...
public class SqlAllFieldsReferenceImpl extends ASTWrapperPsiElement implements SqlAllFieldsReference {

  public SqlAllFieldsReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitAllFieldsReference(this);
  }
  ...
  @Override
  @Nullable
  public SqlAllFieldsColumnNameList getAllFieldsColumnNameList() {
    return findChildByClass(SqlAllFieldsColumnNameList.class);
  }
