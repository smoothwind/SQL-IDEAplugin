...
public class SqlReferenceTypeImpl extends ASTWrapperPsiElement implements SqlReferenceType {

  public SqlReferenceTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SqlReferencedType getReferencedType() {
    return findNotNullChildByClass(SqlReferencedType.class);
  }
