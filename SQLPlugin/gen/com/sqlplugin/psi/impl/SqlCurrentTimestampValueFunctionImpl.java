...
public class SqlCurrentTimestampValueFunctionImpl extends ASTWrapperPsiElement implements SqlCurrentTimestampValueFunction {

  public SqlCurrentTimestampValueFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitCurrentTimestampValueFunction(this);
  }
