...
public class SqlTermImpl extends ASTWrapperPsiElement implements SqlTerm {

  public SqlTermImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SqlFactor getFactor() {
    return findNotNullChildByClass(SqlFactor.class);
  }
