...
public class SqlCCLOBVariableImpl extends ASTWrapperPsiElement implements SqlCCLOBVariable {

  public SqlCCLOBVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitCCLOBVariable(this);
  }
