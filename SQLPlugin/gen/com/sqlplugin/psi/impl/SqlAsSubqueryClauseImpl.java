...
public class SqlAsSubqueryClauseImpl extends ASTWrapperPsiElement implements SqlAsSubqueryClause {

  public SqlAsSubqueryClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitAsSubqueryClause(this);
  }
  ...
  @Override
  @NotNull
  public SqlWithOrWithoutData getWithOrWithoutData() {
    return findNotNullChildByClass(SqlWithOrWithoutData.class);
  }
