...
public class SqlTargetSubtypeImpl extends ASTWrapperPsiElement implements SqlTargetSubtype {

  public SqlTargetSubtypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitTargetSubtype(this);
  }
