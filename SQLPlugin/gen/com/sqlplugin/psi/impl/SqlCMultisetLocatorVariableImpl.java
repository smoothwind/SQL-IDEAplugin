...
public class SqlCMultisetLocatorVariableImpl extends ASTWrapperPsiElement implements SqlCMultisetLocatorVariable {

  public SqlCMultisetLocatorVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitCMultisetLocatorVariable(this);
  }
  ...
  public SqlMultisetType getMultisetType() {
    return findNotNullChildByClass(SqlMultisetType.class);
  }
