...
<YYINITIAL> {
  ...
  "<else clause>"                                              { return <ELSE CLAUSE>; }
  ...
  "<character enumeration exclude>"                            { return <CHARACTER ENUMERATION EXCLUDE>; }
  ...
  "<SQLSTATE subclass value>"                                  { return <SQLSTATE SUBCLASS VALUE>; }
